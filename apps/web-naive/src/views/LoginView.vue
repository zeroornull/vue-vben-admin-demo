      ...
      <section class="card">
        ...
        <NForm @submit.prevent="onSubmit">
          <NFormItem :label="t('login.username')">
            <NInput v-model:value="form.username" autocomplete="username" name="username" />
          </NFormItem>
          ...
          <NFormItem>
            <NButton attr-type="submit" :loading="authStore.loginLoading" style="width: 100%" type="primary">
              {{ t('login.submit') }}
            </NButton>
          </NFormItem>
        </NForm>
