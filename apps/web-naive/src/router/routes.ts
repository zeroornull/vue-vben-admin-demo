...
export const dynamicLayoutChildren: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: { group: '系统', icon: 'audit', menuCode: 'audit', order: 6, title: '操作日志', viewName: 'AuditView' },
  },
  {
    path: 'links',
    name: 'links',
    component: () => import('@/views/LinksView.vue'),
    meta: { group: '系统', icon: 'links', menuCode: 'links', order: 7, title: '外链', viewName: 'LinksView' },
  },
  {
    path: 'about',
    name: 'about',
    component: () => import('@/views/AboutView.vue'),
    meta: { icon: 'about', menuCode: 'about', order: 8, roles: ['admin'], title: '关于', viewName: 'AboutView' },
  },
  {
    path: 'embed',
    name: 'embed',
